...
from diffusers_.loaders import (
    LoraLoaderMixin,
    text_encoder_lora_state_dict,
)
from diffusers_.models.attention_processor import (
    AttnAddedKVProcessor,
    AttnAddedKVProcessor2_0,
    SlicedAttnAddedKVProcessor,
)
from diffusers_.models.lora import LoRALinearLayer
from diffusers_.training_utils import unet_lora_state_dict
from diffusers_.loaders import AttnProcsLayers
from diffusers_.models.attention_processor import LoRAAttnProcessor
from diffusers_.optimization import get_scheduler
from diffusers_.utils import check_min_version, is_wandb_available
from diffusers_.utils.import_utils import is_xformers_available
...
def import_model_class_from_model_name_or_path(pretrained_model_name_or_path: str, revision: str):
    ...
    if model_class == "CLIPTextModel":
        ...
        from diffusers_.pipelines.alt_diffusion.modeling_roberta_series import RobertaSeriesModelWithTransformation
...
class DreamBoothDataset(Dataset):
    ...
    def __init__(
        ...
        for concept in concepts_list:
            inst_img_path = [
                (x, concept["instance_prompt"], concept["label"])
...
def main(args):
    ...
    if accelerator.is_local_main_process:
        ...
        diffusers_.utils.logging.set_verbosity_info()
    else:
        transformers.utils.logging.set_verbosity_error()
        diffusers_.utils.logging.set_verbosity_error()
